  ...
  return (
    <>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px", flexWrap: "wrap", gap: "12px" }}>
        <h2 style={{ color: "var(--text-primary)", fontWeight: "800", fontSize: "26px", margin: 0 }}>Aircraft Management</h2>
        <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
          ...
          <button onClick={openAdd} style={{ backgroundColor: "#d4af37", color: "var(--text-primary)", border: "none", padding: "10px 20px", borderRadius: "6px", fontWeight: "700", cursor: "pointer", fontSize: "14px" }}>+ Add Aircraft</button>
        </div>
      </div>
              ...
              <tbody>
                {filtered.map((a, i) => (
                  <tr key={a.id} style={{ borderBottom: "1px solid #f0f0f0" }}
                    ...
                    <td style={{ padding: "12px 16px", fontSize: "15px", fontWeight: "700", color: "var(--text-primary)" }}>{a.model}</td>
      ...
      {(modal === "add" || modal === "edit") && (
        <div style={{ position: "fixed", inset: 0, backgroundColor: "rgba(0,0,0,0.65)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 200, padding: "20px" }}>
          <div style={{ backgroundColor: "var(--surface)", borderRadius: "12px", padding: "28px", width: "100%", maxWidth: "440px", boxShadow: "0 20px 60px rgba(0,0,0,0.4)" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" }}>
              <h3 style={{ margin: 0, color: "var(--text-primary)", fontSize: "20px", fontWeight: "700" }}>{modal === "add" ? "Add Aircraft" : "Edit Aircraft"}</h3>
      ...
      {modal === "bulk" && (
        <div style={{ position: "fixed", inset: 0, backgroundColor: "rgba(0,0,0,0.7)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 200, padding: "20px" }}>
          <div style={{ backgroundColor: "var(--surface)", borderRadius: "12px", padding: "28px", width: "100%", maxWidth: "700px", maxHeight: "90vh", overflowY: "auto", boxShadow: "0 20px 60px rgba(0,0,0,0.5)" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px" }}>
              <h3 style={{ margin: 0, color: "var(--text-primary)", fontSize: "20px", fontWeight: "700" }}>Bulk Import Aircraft</h3>
              <button onClick={() => setModal(null)} style={{ background: "none", border: "none", fontSize: "20px", cursor: "pointer", color: "#6c757d" }}>✕</button>
            </div>
            ...
            <div style={{ backgroundColor: "var(--background)", borderRadius: "8px", padding: "12px 16px", marginBottom: "16px", fontSize: "13px", borderLeft: "4px solid #17a2b8" }}>
              ...
              <button
                ...
                style={{ marginLeft: "12px", backgroundColor: "#d4af37", color: "#0b1220", border: "none", padding: "3px 10px", borderRadius: "4px", fontSize: "12px", cursor: "pointer", fontWeight: "600" }}
              >Load Example</button>
            </div>
